// ==========================================================================================================================
//  @file ULConnection.cs
// 
//  Implementation of the class ULConnection.
// 
...
{
    /// <summary>
    /// UltraLight DSIConnection implementation class.
    /// </summary>
    public class ULConnection : Simba.DotNetDSI.DSIConnection
    {
        #region Constructor
        ...
        public ULConnection(IEnvironment environment) : base(environment)
        {
        ...
        public override void Connect(Dictionary<string, object> connectionSettings)
        {
            ...
            GetRequiredSetting(UltraLight.UL_UID_KEY, connectionSettings);
            GetRequiredSetting(UltraLight.UL_PWD_KEY, connectionSettings);
        }
...
#if ODBC_DRIVER
        private sealed class Window : System.Windows.Forms.IWin32Window
        {
            private readonly IntPtr m_handle;

            public Window(IntPtr in_handle)
            {
                m_handle = in_handle;
            }
            ...
            PromptType promptType)
        {
            ...
            ULConnectionDialog dialog = new ULConnectionDialog(
                connectionSettings, 
                promptType == PromptType.PROMPT_REQUIRED);
            return (dialog.ShowDialog(new Window(parentWindow)) == System.Windows.Forms.DialogResult.OK);
        }
#endif
            ...
            Dictionary<string, object> requestSettings)
        {
            ...
            VerifyRequiredSetting(UltraLight.UL_UID_KEY, requestSettings, responseSettings);
            VerifyRequiredSetting(UltraLight.UL_PWD_KEY, requestSettings, responseSettings);
            VerifyOptionalSetting(UltraLight.UL_LNG_KEY, requestSettings, responseSettings);

            return responseSettings;
        }

        /// <summary>
        /// Called by DSIConnection.Reset() to reset subclass-specific state.
        /// 
        ...
        {
            SetProperty(ConnectionPropertyKey.DSI_CONN_CURRENT_CATALOG, UltraLight.UL_CATALOG);
            SetProperty(ConnectionPropertyKey.DSI_CONN_SERVER_NAME, "OPlusDriver");
            SetProperty(ConnectionPropertyKey.DSI_CONN_USER_NAME, "User");
        }
