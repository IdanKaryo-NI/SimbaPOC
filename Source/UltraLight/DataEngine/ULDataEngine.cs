// ==========================================================================================================================
//  @file ULDataEngine.cs
// 
//  Implementation of the class ULDataEngine.
// 
...
{
    /// <summary>
    /// UltraLight data engine implementation.
    /// </summary>
    class ULDataEngine : DSIDataEngine
    {
        #region Constructor
        ...
        public ULDataEngine(IStatement statement) : base(statement)
        {
...
#if !ODBC_DRIVER
            // SAMPLE: Here is where you create instances of your custom schemas.
            // To make the custom schema available to ADO.Net applications, 
            // override SConnection.GetCustomSchemas. ULDotNetConnection has an example.

            if (UltraLight.UL_CUSTOMMETADATARESULT.Equals(metadataID))
            {
                return new ULCustomMetadataResult(Log);
            }
#endif

            throw ExceptionBuilder.CreateException(
                OPlusDriver.Properties.Resources.INVALID_METADATA_ID,
                metadataID);
        }
            ...
            bool filterAsIdentifier)
        {
            ...
            switch (metadataID)
            {
                ...
                {
                    return new ULTablesMetadataSource(Log);
                }

                case MetadataSourceID.CatalogOnly:
                {
                    return new ULCatalogOnlyMetadataSource(Log);
                }

                case MetadataSourceID.SchemaOnly:
                {
                    return new ULSchemaOnlyMetadataSource(Log);
                }
                ...
                {
                    return new ULColumnsMetadataSource(Log);
                }

                case MetadataSourceID.TypeInfo:
                {
                    return new ULTypeInfoMetadataSource(Log);
                }
        ...
        public override IQueryExecutor Prepare(string sqlQuery)
        {
            ...
            return new ULQueryExecutor(Log, isSelect, isParameterized);
        }
