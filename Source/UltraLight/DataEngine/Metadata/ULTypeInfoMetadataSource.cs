// ==========================================================================================================================
//  @file ULTypeInfoMetadataSource.cs
// 
//  Implementation of the class ULTypeInfoMetadataSource.
// 
...
namespace OPlusDriver.DataEngine
{
    ...
    ///     USER_DATA_TYPE
    /// </summary>
    class ULTypeInfoMetadataSource : IMetadataSource
    {
        #region Fields
        ...
        /// </summary>
        private readonly List<TypeInfo> m_DataTypes = new List<TypeInfo>();
        ...
        public ULTypeInfoMetadataSource(ILogger log)
        {
        ...
        private void InitializeDataTypes()
        {
            ...
            typeInfo = TypeInfo.CreateTypeInfo(SqlType.Numeric, "NUMERIC", 17);
