// ==========================================================================================================================
//  @file ULCatalogOnlyMetadataSource.cs
// 
//  Implementation of the class ULCatalogOnlyMetadataSource.
// 
...
{
    /// <summary>
    /// UltraLight sample metadata table for catalogs.
    /// 
    /// This source contains the following output columns as defined by SimbaEngine:
    ///     SCHEMA_NAME
    /// </summary>
    class ULCatalogOnlyMetadataSource : IMetadataSource
    {
        #region Fields
        ...
        public ULCatalogOnlyMetadataSource(ILogger log)
        {
